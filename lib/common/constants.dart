...
const String WORDPRESS_URL = "https://f3nation.com";

// Home tab name
const String PAGE1_CATEGORY_NAME = "F3 News";

// Featured category ID (for Home Screen top section)
const int FEATURED_ID = 110;

// Tab 2 page category name
const String PAGE2_CATEGORY_NAME = "Q Source";

// Tab 2 page category ID
const int PAGE2_CATEGORY_ID = 10188;
